...
public class ProductService {
	...
	public BaseResponce<Void> addToCart(UserBasket userBasket) {
		...
		int update=	userBasketDao.updateUserBasket(userBasket.getProductName(),userBasket.getQuantity(),userBasket.getEmail());
		if(update>0)	{
		baseResponce.setStatusCode(ResponceConstants.SUCCESS_CREATED);
		baseResponce.setStatusMessage(ResponceConstants.UPDATE);}else {
